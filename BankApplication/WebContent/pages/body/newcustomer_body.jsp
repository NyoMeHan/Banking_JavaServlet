...
<body>
	<form name="Newcustomer" action="${pageContext.request.contextPath}/Newcustomer.iss" method="post" id = "register-form">
...
<!-- 				<td>CustomerID</td> -->
				...
				<td><input type="hidden" name="id" disabled = false></td>
			</tr>
			<tr>
				<td>FirstName</td>
...
<!-- 				<td><input type="text" name="nationality" id = nationality></td> -->
				...
				name="gender" value="male" checked id = gender> Male
		        </label>
		        <label class="radio"> <input type="radio"
				name="gender" value="female" id = gender> Female
		        </label></td>
			<tr>
				<td>DOB</td>
			...
			<tr>
				<td>Created_By</td>
				<td><input type="text" id="created_by" name="created_by" value = "${created_by}" disabled= false></td>
			</tr>
			<tr>
				<td>Created_On</td>
				<td><input type="text" id="created_on" name="created_on" value="${created_on}" disabled= false ></td>
			</tr>
			<tr>
<!-- 			<td><input  type="submit" name="method" value="Save" /></td> -->
			...
			<td><a href="${pageContext.request.contextPath}/CustomerListing.iss?method=Exit">Back</a></td>
